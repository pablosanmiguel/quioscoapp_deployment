   ...
   return (
      <div className="shadow p-5 mb-3 flex gap-10 items-center">
         ...
         <div>
            <button
               type="button"
               className="flex gap-2 bg-sky-700 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full text-center"
            ...
            <button
               type="button"
               className="flex gap-2 bg-red-700 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full text-center mt-3"
